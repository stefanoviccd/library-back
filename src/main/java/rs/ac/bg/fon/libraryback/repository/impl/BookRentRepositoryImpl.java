...
public class BookRentRepositoryImpl implements BookRentRepository {
    @Override
    public List<BookRent> getByUser(Long memberId, EntityManager em) {
    ...
    @Override
    public BookRent save(BookRent bookRent, EntityManager em) {
    ...
    @Override
    public void update(BookRent bookRent, EntityManager em) {
    ...
    @Override
    public List<BookRent> getCurrentlyActiveRents(EntityManager em) {
    ...
    @Override
    public List<BookRent> getByBook(Long id, EntityManager em) {
